...
The Host half keeps `ui-onboarding` registered in the user-settings seam so stored documents from earlier first-run notices remain valid; the shell itself is policy-free.
