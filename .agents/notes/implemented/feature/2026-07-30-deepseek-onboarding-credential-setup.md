...
Superseded by the [first-run onboarding dialogs removal](../simplification/2026-08-17-remove-first-run-onboarding-dialogs.md); the Baizor AI login button is now the first-run credential entry point.
