...
Superseded by the [first-run onboarding dialogs removal](../simplification/2026-08-17-remove-first-run-onboarding-dialogs.md), which deletes both steps this note describes.
