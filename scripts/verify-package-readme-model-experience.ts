...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/extensions/baizor-auth': { kind: 'indirect', reason: 'The login writes provider settings and the default model; request assembly and provider adapters own every model-visible request.' },
  ...
  'packages/extensions/ui-baizor-login': { kind: 'none', reason: 'Browser-side login button; it starts and settles the host baizorAuth flow and registers no model surface.' },
